...
def resolve_task_dir(target_dir: str, repo_root: Path) -> Path:
    ...
    - Relative path: .rudder/tasks/01-31-my-task
    ...
    # Relative path (contains path separator or starts with .rudder)
    if "/" in normalized or normalized.startswith(".rudder"):
...
if __name__ == "__main__":
    ...
    print(f"is_safe_task_path('.rudder/tasks/test'): {is_safe_task_path('.rudder/tasks/test', repo)}")
