...
5. `.rudder/spec/` — project-wide guidelines (load only what is relevant to the diff under review)
...
3. **Review against specs** — naming, structure, type safety, error handling, conventions in `.rudder/spec/`
