"""添加多 LLM 候选比较表（SQLite）

Revision ID: 91ac57e4
Revises: 74d19be2
"""
...
revision: str = "91ac57e4"
down_revision: Union[str, None] = "74d19be2"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("parameters_snapshot", sa.JSON(), nullable=False, server_default="{}"),
