"""添加 LLM 服务配置、任务路由和调用日志

Revision ID: c7d2a410
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("default_model", sa.String(150), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("task_trace_id", sa.String(36), nullable=True),
        sa.Column("user_id", sa.String(100), nullable=False),
        ...
        sa.Column("requested_model", sa.String(150), nullable=True),
        ...
        sa.Column("fallback_from_config_id", sa.String(36), nullable=True),
